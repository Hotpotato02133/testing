...
const dbServerHostJava = "https://techsit.orobusinessgroup.online/site102";
...
function OroReport() {
    ...
    const fetchData = async () => {
        ...
        let tWhere = `?from=${selectedDateRange.from}&to=${selectedDateRange.to}`;
        ...
        try {
            ...
            if (Number(json.status) === 200){
                ...
                throw new Error("API Error in sales: " + json.status + ", " + (json.errors === undefined ? json.error : json.errors));
            }
        } catch (err) {
